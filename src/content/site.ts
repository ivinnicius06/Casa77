...
// Plans transcribed from Casa 77 screenshots supplied on 2026-09-11.
export const plans: Plan[] = [
  {
    id: "01",
    name: "PLUS 77 - CORTE LIMITADO",
    label: "Corte",
    description: "Segunda, terça e quarta",
    price: 79.99,
    benefits: ["CORTE - CLUB"],
    recommended: false,
    provisional: false,
  ...
  {
    id: "04",
    name: "+PLUS 77 - CORTE E BARBA LIMITADO",
    label: "Corte e barba",
    description: "Segunda, terça e quarta",
    price: 139.99,
    benefits: ["CORTE / BARBA - CLUB 77", "BARBA - CLUB 77", "CORTE - CLUB 77"],
    recommended: false,
    provisional: false,
  },
  {
    ...
    description: "Todos os dias",
    price: 139.99,
    benefits: ["CORTE - PRIME77", "CORTE - CLUB 77"],
    recommended: false,
    provisional: false,
  },
  {
    id: "06",
    name: "BLACK - CORTE E BARBA CLUB 77",
    label: "Corte e barba",
    description: "Todos os dias",
    price: 174.99,
    benefits: ["CORTE / BARBA - CLUB", "CORTE - CLUB", "BARBA - CLUB"],
    recommended: false,
    provisional: false,
  },
  {
